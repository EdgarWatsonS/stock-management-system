...
$stockSubtractedData = $db->query("SELECT * FROM stock_out WHERE MONTH(date) = '$selectedMonth' AND YEAR(date) = '$selectedYear'");

// Retrieve the distinct months and years for which stock subtracted data exists
$availableMonths = $db->query("SELECT DISTINCT MONTH(date) AS month, YEAR(date) AS year FROM stock_out");
...
<head>
    <meta charset="utf-8">
    <title>Stock Subtracted Report</title>
            ...
            <div class="side-content fr">
                <div class="content-module">
                    <div class="content-module-heading cf">
                        <h3 class="fl">Stock Subtracted Report - <?php echo date('F Y', strtotime($selectedYear . '-' . $selectedMonth . '-01')); ?></h3>
