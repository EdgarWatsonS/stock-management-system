...
if ($count > 0) {
    // Stock exists, subtract the stock quantity
    ...
    // Insert into the 'stock_out' table
    $current_date = date("Y-m-d"); // Get the current date
    $db->query("INSERT INTO stock_out(stock_id, stock_name, category, stock_quatity, date) VALUES ('$stock_id', '$name', '$category', '$stock_quatity', '$current_date')");
