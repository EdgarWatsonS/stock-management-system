...
if(isset($_SESSION['username'])) {
    if($_SESSION['user_type'] =='admin') // if session variable "username" does not exist.
...
<?php include_once("analyticstracking.php") ?>
	...
	<div id="header">
        ...
        <h1 style="margin-left: 440px; font-family: Georgia;     font-weight: bold; font-size:20px; color: #0060BF">&nbsp;&nbsp;&nbsp;</h1>
