...
while($row = mysqli_fetch_array($result)) 
{
 ?> 
   ...
   <td> <?php $quantity = $db->queryUniqueValue("SELECT quantity FROM stock_avail WHERE name='".$row['name']."'"); echo $quantity; ?></td>
...
<?php $i++; } ?>
 <tr>
       ...
       <td align="center" colspan="4"><div><?php echo $pagination; ?></div></td>
