	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<li><a href="user_dashboard.php" class="active-tab dashboard-tab">Dashboard</a></li>
				...
				<li><a href="user_view.php" class="active-tab stock-tab">Stocks / Products</a></li>
				<li><a href="user_stock.php" class="payment-tab">Stock Out</a></li>
		...
		<div class="page-full-width cf">
			...
			<div class="side-menu fl">
				...
				<!--	<li><a href="add_stock.php">Add Stock/Product</a></li> -->
					<li><a href="user_view.php">View Stock/Product</a></li>
...
<input type="hidden" name="return" value="user_view.php">
...
$query = "SELECT COUNT(*) as num FROM  stock_details WHERE stock_name LIKE '%".$_POST['searchtxt']."%' OR stock_id LIKE '%".$_POST['searchtxt']."%' OR supplier_id LIKE '%".$_POST['searchtxt']."%' OR date LIKE '%".$_POST['searchtxt']."%'";
	...
	$targetpage = "user_view.php"; 	//your file name  (the name of this file)
	...
	*/
	...
	{	
		...
		if ($page > 1) 
			...
			$pagination.= "<a href=\"user_view.php?page=$prev&limit=$limit\" class=my_pagination >Previous</a>";
		...
		{	
...

			{
				...
				if ($counter == $page)
					...
					$pagination.= "<a href=\"user_view.php?page=$counter&limit=$limit\" class=my_pagination>$counter</a>";					
...

		{
...

			{
				...
				$pagination.= "<a href=\"user_view.php?page=$lpm1&limit=$limit\" class=my_pagination>$lpm1</a>";

				$pagination.= "<a href=\"user_view.php?page=$lastpage&limit=$limit\" class=my_pagination>$lastpage</a>";		
...

			{
				...
				$pagination.= "<a href=\"user_view.php?page=1&limit=$limit\" class=my_pagination>1</a>";

				$pagination.= "<a href=\"user_view.php?page=2&limit=$limit\" class=my_pagination>2</a>";
		...
		if ($page < $counter - 1) 
			...
			$pagination.= "<a href=\"user_view.php?page=$next&limit=$limit\" class=my_pagination>Next</a>";
...
<?php $i++; } ?>
 <tr>
       ...
       <td align="center" colspan="9"><div style="margin-left:20px;"><?php echo $pagination; ?></div></td>
		...
		<div id="footer">
	<p> &copy;<strong> Copyright SsekirandaEdgarWatson</strong></p>
